...
public class PreviewFragment_back extends Fragment {

    public final static String TAG = "PreviewFragment_back";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.preview_back,container,false);

        mTextView = (TextView)rootView.findViewById(R.id.tooltip_back);

        if (((SpydroidActivity)getActivity()).device == ((SpydroidActivity)getActivity()).TABLET) {

            mSurfaceView = (SurfaceView)rootView.findViewById(R.id.tablet_camera_view_back);
