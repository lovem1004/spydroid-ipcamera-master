...
public class AACLATMPacketizer extends AbstractPacketizer implements Runnable {
	...
	private static String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/testAudioLatm.aac";
	...
	public void run() {
		...
		Log.e(TAG,"AAC LATM packetizer started !");
		...
		try {
			while (!Thread.interrupted()) {
				...
				//Log.e(TAG, "1------------------------- length = " + length);

				//outputStream.write(buffer, rtphl+4, length);
//				for(int i=0; i< length; i++) {
//					Log.e(TAG, "-------------buffer[" + i + "] = " + buffer[i]);
//				}
				//Log.e(TAG, "1------------------------- buffer.length = " + buffer.length);
				if (length>0) {
...
//					Log.e(TAG, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  rtphl = " + rtphl);
//					Log.e(TAG, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  length = " + length);
//					Log.e(TAG, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  rtphl+length+4 = " + (int)rtphl+(int)length+4);
					buffer[rtphl] = 0;
					buffer[rtphl+1] = 0x10; 
					...
					outputStream.write(buffer, 0, rtphl+length+4);
